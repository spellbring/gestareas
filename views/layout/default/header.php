    ...
    <div id="modal_dialog" class="modal-dialog modal-lg">
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="<?php echo BASE_URL ?>sistema" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text"><img width="120px" src="<?php echo $_layoutParams["ruta_img"] ?>logo-grande.png"></span><span style="display: none" class="logo-text-icon">µ</span></a></div>
         ...
         <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="<?php echo BASE_URL?>proyecto"><i class="fa fa-code fa-fw">
                        <div class="icon-bg bg-pink"></div>
