function Sistema(){
 ...
 Sistema.prototype.abreModal = function(urlCarga, titulo){
        $.ajax({
             type:"POST", 
             url:urlCarga,  
             cache: false,
     ...
     Sistema.prototype.procesoEnviaForm = function(classFrm,url,btn,urlCarga){
$("#" + btn).attr('disabled', 'disabled');
 ...
 Sistema.prototype.procesoEnviaFormOrganizacion = function(classFrm,url,btn,div){
      var formData = new FormData($("." + classFrm)[0]);
